...
#
sub getExperimentControlPorts ($$) { #@@@@ OK
    my ($pid, $eid) = @_;
    ...
    #
    return @ports; #@@@@ return convertPortsFromIfaces(@ports);
}
...
#
sub getDeviceNames(@) { # @@@@ refactored to use Port class
    my @ports = @_;
    my %devices = ();
