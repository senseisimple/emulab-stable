...
CREATE TABLE `emulab_pubs` (
  ...
  `submitted_by` mediumint(8) unsigned NOT NULL default '0',
  `last_edit` datetime NOT NULL default '0000-00-00 00:00:00',
  `last_edit_by` mediumint(8) unsigned NOT NULL default '0',
  ...
  `month` float(3,1) NOT NULL default '0.0',
...
CREATE TABLE `emulab_pubs_month_map` (
  ...
  `month` float(3,1) NOT NULL default '0.0',
  `month_name` char(8) NOT NULL default '',
  PRIMARY KEY  (`month`),
...
CREATE TABLE `plab_nodehist` (
  ...
  `node_id` varchar(32) NOT NULL default '',
  `phys_node_id` varchar(32) NOT NULL default '',
...
CREATE TABLE `plab_objmap` (
  `plc_idx` int(10) unsigned NOT NULL default '0',
  `objtype` varchar(32) NOT NULL default '',
  `elab_id` varchar(64) NOT NULL default '',
  `plab_id` varchar(255) NOT NULL default '',
