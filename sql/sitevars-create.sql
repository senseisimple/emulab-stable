...
INSERT INTO sitevariables VALUES ('web/message','Cluster use limited to those with imminent deadlines!','','Message to place in large lettering under the login message on the Web Interface.');
