...
bool dashboard::update(unsigned long now)
{
	...
	this->db_telemetry.user_button =
	    this->db_garcia.getNamedValue("user-button")->getIntVal();
	
	this->db_telemetry.user_led =
	    this->db_garcia.getNamedValue("user-led")->getIntVal();
