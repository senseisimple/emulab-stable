...
function ts_makeSortable(table) {
    ...
    for (var i=0;i<firstRow.cells.length;i++) {
        ...
        if (ts_hasLink(cell)) continue;
        cell.innerHTML = '<a href="#" class="sortheader" onclick="ts_resortTable(this);return false;">'+cell.innerHTML+'<span class="sortarrow">&nbsp;&nbsp;&nbsp;</span></a>';
    }
}

function ts_hasLink(el) {
