...
{	
	...
	public class LinkGroup
	{
		...
		public var owner:LinkGroupCollection = null;
		public var collection:ArrayCollection = new ArrayCollection;
		
		public function LinkGroup(lat1:Number, lng1:Number, lat2:Number, lng2:Number, own:LinkGroupCollection)
		{
			latitude1 = lat1;
			longitude1 = lng1;
			latitude2 = lat2;
		...
		public function Add(l:Link):void {
		...
		public function TotalBandwidth():Number {
			var bw:Number = 0;
			for each(var l:Link in collection) {
				bw += l.bandwidth;
			}
			return bw;
		}
