...
package protogeni.resources
{
	...
	public final class PhysicalNodeGroupCollection
	{
		...
		public var collection:Vector.<PhysicalNodeGroup>;
		
		public function PhysicalNodeGroupCollection(own:GeniManager)
		{
			this.collection = new Vector.<PhysicalNodeGroup>();
			this.owner = own;
		}
		...
		public function GetByLocation(lat:Number,
									  lng:Number):PhysicalNodeGroup {
			for each(var ng:PhysicalNodeGroup in this.collection) {
