...
package protogeni.communication
{
	...
	public final class RequestTicketUpdate extends Request
	{
		...
		{
			super("TicketUpdate",
				"Updating ticket for sliver on " + s.componentManager.Hrn + " for slice named " + s.slice.hrn,
				CommunicationUtil.updateTicket);
			sliver = s;
			ticket = t;
